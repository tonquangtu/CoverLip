...
public class FileUploadController {
    ...
    ModelAndView uploadFileHandler(@RequestParam("name") String name,
        ...
        if (!file.isEmpty()) {
            try {
                ...
                System.out.println("File Name: " + serverFile.getAbsolutePath());
    ...
    @RequestMapping("person/uploadVideo")
    public ModelAndView visitUploadPage() {

        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("commonpage/personalpage/upload_video_page");
        return modelAndView;
    }
