...
<div class="my_idol main_person">
    <div class="subhead">
        <h2 class="subhead-heading">Idol Của Tôi</h2>
    </div>
    <div style="padding-right:0; padding-left:0; margin-top: 45px;">
        <!-- Main-->
        <c:forEach items="${idolList}" var="item1" varStatus="i">
            <c:if test="${i.index<9}">
    ...
    <div id="loading" currentItemId="${(idolList!=null&&idolList.size()>0)?idolList.get(idolList.size()-1).account.id:0}" type="${type}" accountid="${userInfo.account.id}">
